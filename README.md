...
### Install following Libraries for a GPIO access accessible from Node.js
...
### Settings for Firefox ( our videoplayer )
...
## Mouse Jiggler --> There is a issue with our autostart and wayladn -> Solution: use MouseJiggler
